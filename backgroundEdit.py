...
from backgroundTabs.educationEdit import educationEdit
...
def backgroundEdit(options, button, bg, secondary_bg, tertiary_bg, root):
    # disable body type button until window is closed
    button.config(state=tk.DISABLED)

    backgroundWindow = tk.Toplevel(master=root)
