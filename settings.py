...
def readConfigFile(bg, secondary_bg):
    ...
    options = {}
    terms = ['Number of Swipes', 'Check Percentage', 'Minimum Percentage', 'Check Images',  'Minimum Number of Images', 'Check Words',  'Minimum Word Count', 'Check Questions',  'Minimum Questions Answered', 'Orientation', 'Relationship', 'Body Type', 'Ethnicity', 'Education', 'Religion', 'Lifestyle', 'Family', 'Cigarettes', 'Alcohol', 'Marijuana', 'Pets', 'Kids', 'Phrases', 'Check Criteria', 'Check Intro']
    for term in terms:
        if term[0:5] == 'Check':
            try:
        ...
        elif term[0:12] == 'Orientation' or term[0:4] == 'Body' or term[0:11] == 'Ethnicity' or term[0:7] == 'Phrases' or term[0:8] == 'Religion' or term[0:9] == 'Education' or term[0:12] == 'Relationship' or term[0:9] == 'Lifestyle' or term[0:6] == 'Family' or term[0:10] == 'Cigarettes' or term[0:7] == 'Alcohol' or term[0:9] == 'Marijuana' or term[0:4] == 'Pets' or term[0:4] == 'Kids':
            try:
