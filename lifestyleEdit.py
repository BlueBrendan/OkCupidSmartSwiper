...
from lifestyleTabs.cigarettesTab import cigarettesEdit
from lifestyleTabs.alcoholTab import alcoholEdit
from lifestyleTabs.marijuanaTab import marijuanaEdit
...
def lifestyleEdit(options, button, bg, secondary_bg, tertiary_bg):
    ...
    cigarettesEdit(tab_parent, options)
    alcoholEdit(tab_parent, options)
    marijuanaEdit(tab_parent, options)
