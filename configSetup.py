...
def readConfigFile():
    ...
    options = {}
    terms = ['Number of Swipes', 'Check Percentage', 'Minimum Percentage', 'Check Images',  'Minimum Number of Images', 'Check Words',  'Minimum Word Count', 'Check Questions',  'Minimum Questions Answered', 'Body Types', 'Ethnicity Types']
    for term in terms:
        if (term[0:5] == 'Check'):
            try:
                ...
                createConfigFile()
                readConfigFile()
        elif term[0:4] == 'Body' or term[0:9] == 'Ethnicity':
